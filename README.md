...
The subfolder `figures_and_tables/` contains the R scripts for reproducing the figures and tables in our paper and supplementary information, including Figure 1-5, Figure S2-S5, and Table S2-S4. 
