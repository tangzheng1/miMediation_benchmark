MODIMAstat <- function(exposure, mediator, response){
  EM = energy::bcdcor(exposure, mediator)
  MRE =energy::pdcor(mediator, response, exposure)
  MODIMAstat <- EM*MRE
...
# q_bar <- 1-p_bar
# 
# n_est <- (1.96*sqrt(2*p_bar*q_bar)+0.84*sqrt(0.103*(1-0.103)+0.078*(1-0.078)))^2/((0.103-0.078)^2)
# print(n_est)
